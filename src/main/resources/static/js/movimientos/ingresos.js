document.addEventListener("DOMContentLoaded", function () {
  ...
  function abrirDetalleConcepto(concepto) {
    ...
    tbody.innerHTML =
      '<tr><td colspan="4" class="text-center"><div class="spinner-border text-success spinner-border-sm"></div></td></tr>';
      ...
      .then((ingresos) => {
        ...
        ingresos.forEach((ingreso) => {
          ...
          tr.innerHTML = `
                    ...
                    <td class="text-end fw-bold text-success">$${ingreso.monto.toFixed(
                      2
                    )}</td>
                    <td class="text-end">
